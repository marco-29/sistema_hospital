...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/styles-menu.css') ?>">
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgba(201, 201, 201, 0);">
        <div class="container-fluid">
            <a href="<?php echo base_url('aprende/aprende')?>"><img src="<?php echo base_url('almacenamiento/recursos/luna.png') ?>" alt="" class="img-fluid ms-2" width="50%"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <!-- <div class="d-flex mx-5">
                        <div style="position: relative;border: 5px solid green; border-radius: 50%; background-color: #1F2C4F;">
                            <img src="<?php echo base_url('almacenamiento/recursos/Cabeza-DIUFO.png') ?>" alt="" class="img-fluid" width="120">
                        </div>
                        <div style="border: 5px solid green; border-radius: 15%; width: 100%; margin-left: -20px; background-color: #1F2C4F;" class="text-center">
                            <h1 class="text-white">4</h1>
                        </div>
                    </div> -->
                    <div>
                        <a href=""><img src="<?php echo base_url('almacenamiento/recursos/btn-estadisticas.png') ?>" alt="" class="img-fluid" width="220"></a>
                        <a href="<?php echo site_url('login/cerrar_sesion')?>" id="cerrarSesion" class="btn btn-danger">Cerrar sesion</a>
                    </div>
                </form>
            </div>
        </div>
